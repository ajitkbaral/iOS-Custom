...
class CustomTableViewController: UITableViewController {
    ...
    let data = [("Beach","America", "1.jpg"), ("Mountains", "Nepal", "2.jpg"), ("Sailor", "Italy", "3.jpg"), ("City", "New York", "4.jpg")]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let (title, location, image) = data[indexPath.row]
        cell.lableTitle.text = title
        cell.labelLocation.text = location
        cell.imageViewLocation.image = UIImage(named: image)!
